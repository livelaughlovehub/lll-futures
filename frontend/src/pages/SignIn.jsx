...
export default function SignIn() {
  ...
  const handleGoogleSignin = async () => {
    ...
    console.log('Google OAuth2.0 signin clicked')
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Other Sign In Options</h3>
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
              <User className="text-gray-500 mr-3" size={20} />
              <span className="text-gray-700">Connect with Wallet</span>
            </button>
            <p className="text-sm text-gray-500 text-center">
              Or use the wallet button in the navigation to connect your Solana wallet
            </p>
          </div>
        </div>
      </div>
