      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-2xl px-6 py-3 rounded-lg inline-block mb-4">
              LL&L Futures
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Create Your Account</h1>
            <p className="text-gray-600">Join the prediction market revolution</p>
          </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-green-600 text-sm">You'll receive 50 LLL tokens to start trading!</p>
                </div>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? (
                ...
                'Create Account & Get 50 LLL Tokens'
              )}
            </button>
          </form>
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              <span className="text-gray-700">50 real LLL tokens to start trading</span>
            </div>
            <div className="flex items-center">
              <div className="bg-blue-100 rounded-full p-2 mr-3">
                <Mail className="text-blue-600" size={16} />
              </div>
              <span className="text-gray-700">Access to all prediction markets</span>
            </div>
            <div className="flex items-center">
              <div className="bg-purple-100 rounded-full p-2 mr-3">
                <Lock className="text-purple-600" size={16} />
              </div>
              <span className="text-gray-700">Set up your profile after signup</span>
            </div>
          </div>
        </div>
      </div>
